...
import 'package:meals_app/resources/mealsApiProvider.dart';
...
void main() {
  ...
  group('testApi', () {
    test(
        'returns Result ItemModel of Seafood List if the http call completes successfully',
        () async {
    ...
    test(
        'returns Result ItemModel of Dessert List if the http call completes successfully',
        () async {
      when(client.get(Uri.parse(
    ...
    test(
        'returns Result ItemModel of Detail Dessert if the http call completes successfully',
        () async {
      when(client.get(Uri.parse(
    ...
    test(
        'returns Result ItemModel of Search Pie if the http call completes successfully',
        () async {
      when(client.get(Uri.parse(
